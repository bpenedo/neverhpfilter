...
cycle_plot <- function(x, ...) {
        
employ_cycle <- yth_filter(x, h = 8, p = 4, output = c("cycle","random"), family = gaussian)
employ_cycle$Zero <- 0

plot.xts(employ_cycle, col=c("black", "red"), grid.col = "white", main="Log of Employment cycle and random")
addLegend("topright", legend.names = c("Cyclical Component", "2 year (8 quarter) diff"), 
          lty=c(1, 1), col=c("black", "red"))
}

cycle_plot(log_Employment)
```
