...
plot(gdp_filtered["1950/"][,1:2], legend.loc = "topleft", main = main,  panels = 'lines(gdp_filtered["1950/"][,3], type="h", on=NA)')
```
...
One may wish to consider longer-term cycles by extending `h`. Below is an example of taking h from 8 quarters or 2 years, to 40 quarters (10 years). 
```{r}
